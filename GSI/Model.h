...
public:
    ...
    */
    ...
    /*
    * Définie les probabilités aléatoires (loi uniforme) sur les arêtes protéines-peptides. Si le paramètre per_protein est à vrai, alors la probabilité des arêtes adjacentes à une même protéine obtiennent la même probabilité.
    */
    ...
    * Génère un ensemble de spectres simulés à partir des protéines, des peptides théoriques et des probabilités.
    * Pour cela, il faut fournir un échantillon sous la forme d'une map associant des numéros de protéines à des abondances.
    * La façon dont les spectres sont sélectionné est directement dépendante de la fonction à fournir en paramètre.
    ...
    */
    ...
    /*
    * Permet d'affecter des scores aux arêtes spectres-peptides à partir d'un fichier à indiquer en paramètre. Le parser doit être fournit.
    ...
    * Celle-ci doit prendre en paramètre un std::vector<Peptide*>, un std::vector<Spectrum*> et un std::vector<Score*> (liste de score à remplir).
    */
